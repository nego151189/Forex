...
class CandlestickChart {
    ...
    render(data) {
        ...
        this.data = data;
        // Mostrar solo las últimas 30 velas para que se vean más grandes
        ...
        const chartHeight = 500; // Aumentado de 400 a 500
    ...
    createCandle(candle, minPrice, priceRange, chartHeight, index) {
        ...
        return `
            <div class="candlestick" 
                 style="height: ${chartHeight}px; min-width: 12px;" 
                ...
                <div style="position: absolute; top: ${highY}px; width: 100%; display: flex; flex-direction: column; align-items: center;">
                    ...
                    <div class="wick wick-upper" 
                         style="height: ${upperWickHeight}px; width: 2px; background: ${isBullish ? '#00ff88' : '#ff4757'};"></div>
                    
                    <!-- Cuerpo de la vela -->
                    <div class="candle-body ${isBullish ? 'candle-bullish' : 'candle-bearish'}" 
                         style="height: ${bodyHeightPx}px; width: 12px;"></div>
                    
                    <!-- Mecha inferior -->
                    <div class="wick wick-lower" 
                         style="height: ${lowerWickHeight}px; width: 2px; background: ${isBullish ? '#00ff88' : '#ff4757'};"></div>
                </div>
            </div>
        `;
    }
    ...
    updateRealTime(newCandle) {
        ...
        if (!newCandle.isRealData) {
            console.warn('Intentando agregar dato no real');
            return;
        }
